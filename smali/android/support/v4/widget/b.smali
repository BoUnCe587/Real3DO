...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/widget/b;->a(Landroid/content/Context;Landroid/database/Cursor;I)V
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/widget/b$a;-><init>(Landroid/support/v4/widget/b;)V

    iput-object v1, p0, Landroid/support/v4/widget/b;->f:Landroid/support/v4/widget/b$a;

    new-instance v1, Landroid/support/v4/widget/b$b;

    invoke-direct {v1, p0, v3}, Landroid/support/v4/widget/b$b;-><init>(Landroid/support/v4/widget/b;Landroid/support/v4/widget/b$1;)V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/widget/b;->g:Landroid/database/DataSetObserver;
    ...
    :cond_5
    iput-object v3, p0, Landroid/support/v4/widget/b;->f:Landroid/support/v4/widget/b$a;

    iput-object v3, p0, Landroid/support/v4/widget/b;->g:Landroid/database/DataSetObserver;
