...
# instance fields
.field a:Landroid/support/v4/h/a;

.field private final b:Landroid/support/v7/internal/widget/ActivityChooserView$a;

.field private final c:Landroid/support/v7/internal/widget/ActivityChooserView$b;

.field private final d:Landroid/support/v7/widget/g;
...
.field private k:Landroid/support/v7/widget/h;
...
.method static synthetic a(Landroid/support/v7/internal/widget/ActivityChooserView;)Landroid/support/v7/internal/widget/ActivityChooserView$a;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/ActivityChooserView$a;
...
.method private a(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ActivityChooserView$a;->d()Landroid/support/v7/internal/widget/d;
    ...
    :goto_0
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/ActivityChooserView$a;

    invoke-virtual {v3}, Landroid/support/v7/internal/widget/ActivityChooserView$a;->c()I
    ...
    invoke-virtual {v3, v4}, Landroid/support/v7/internal/widget/ActivityChooserView$a;->a(I)V

    :goto_2
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/h;
    ...
    :cond_1
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/ActivityChooserView$a;
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ActivityChooserView$a;->a()I
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/h;->f(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/h;->c()V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/h/a;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/h/a;

    invoke-virtual {v0, v1}, Landroid/support/v4/h/a;->a(Z)V

    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/h;->m()Landroid/widget/ListView;
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/internal/widget/ActivityChooserView$a;->a(I)V
...
.method private getListPopupWindow()Landroid/support/v7/widget/h;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/h;
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/h;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/h;

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/h;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/ActivityChooserView$a;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/h;->a(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/h;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/h;->a(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/h;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/h;->a(Z)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/h;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->c:Landroid/support/v7/internal/widget/ActivityChooserView$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/h;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/h;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->c:Landroid/support/v7/internal/widget/ActivityChooserView$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/h;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->d:Landroid/support/v7/widget/g;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/g;->layout(IIII)V
...
.method public setActivityChooserModel(Landroid/support/v7/internal/widget/d;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/ActivityChooserView$a;->a(Landroid/support/v7/internal/widget/d;)V
...
.method public setProvider(Landroid/support/v4/h/a;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/h/a;
