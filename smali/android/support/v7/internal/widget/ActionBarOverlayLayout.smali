...
.field private final B:Landroid/support/v4/h/j;
...
.field private w:Landroid/support/v4/widget/j;

.field private x:Landroid/support/v4/h/u;

.field private final y:Landroid/support/v4/h/x;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/h/x;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/h/j;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/h/j;

    return-void
.end method

.method static synthetic a(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/h/u;)Landroid/support/v4/h/u;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/h/u;
...
.method private a(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Landroid/support/v4/widget/j;->a(Landroid/content/Context;)Landroid/support/v4/widget/j;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/j;
...
.method private a(FF)Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/j;
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/support/v4/widget/j;->a(IIIIIIII)V
...
.method static synthetic b(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;)Landroid/support/v4/h/x;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/h/x;
...
.method private c()V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/h/u;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/h/u;

    invoke-virtual {v0}, Landroid/support/v4/h/u;->a()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/h/l;->c(Landroid/view/View;)F
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/h/l;->f(Landroid/view/View;)I
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/h/l;->c(Landroid/view/View;)F
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/h/j;

    invoke-virtual {v0}, Landroid/support/v4/h/j;->a()I
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/f;->a()Ljava/lang/CharSequence;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Landroid/support/v4/h/l;->g(Landroid/view/View;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget v8, v0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout$b;->leftMargin:I
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/h/j;->a(Landroid/view/View;Landroid/view/View;I)V
...
.method public setActionBarHideOffset(I)V
    ...
    invoke-static {v1, v0}, Landroid/support/v4/h/l;->a(Landroid/view/View;F)V
