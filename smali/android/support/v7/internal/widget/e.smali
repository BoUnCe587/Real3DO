...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v7/internal/widget/e;->a:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/internal/widget/e;->a(Z)V
    ...
    invoke-static {p0}, Landroid/support/v7/internal/widget/e;->a(Landroid/widget/PopupWindow;)V
...
.method private static a(Landroid/widget/PopupWindow;)V
    ...
    new-instance v3, Landroid/support/v7/internal/widget/e$1;

    invoke-direct {v3, v1, p0, v0}, Landroid/support/v7/internal/widget/e$1;-><init>(Ljava/lang/reflect/Field;Landroid/widget/PopupWindow;Landroid/view/ViewTreeObserver$OnScrollChangedListener;)V
...
.method public a(Z)V
    ...
    sget-boolean v0, Landroid/support/v7/internal/widget/e;->a:Z

    if-eqz v0, :cond_0

    iput-boolean p1, p0, Landroid/support/v7/internal/widget/e;->b:Z

    :goto_0
    return-void

    :cond_0
    invoke-static {p0, p1}, Landroid/support/v4/widget/e;->a(Landroid/widget/PopupWindow;Z)V
...
.method public showAsDropDown(Landroid/view/View;II)V
    ...
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/e;->b:Z
