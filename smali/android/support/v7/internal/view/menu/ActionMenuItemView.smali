...
.field private e:Landroid/support/v7/widget/h$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Landroid/support/v7/b/a$j;->ActionMenuItemView:[I

    invoke-virtual {p1, p2, v1, p3, v3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v1

    sget v2, Landroid/support/v7/b/a$j;->ActionMenuItemView_android_minWidth:I
...
.method private e()V
    ...
    invoke-virtual {v3}, Landroid/support/v7/internal/view/menu/f;->m()Z
...
.method public a(Landroid/support/v7/internal/view/menu/f;I)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->e:Landroid/support/v7/widget/h$b;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->e:Landroid/support/v7/widget/h$b;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/f;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/h/l;->a(Landroid/view/View;)I
    ...
    :cond_1
    iget-object v8, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->a:Landroid/support/v7/internal/view/menu/f;

    invoke-virtual {v8}, Landroid/support/v7/internal/view/menu/f;->getTitle()Ljava/lang/CharSequence;
...
.method protected onMeasure(II)V
    ...
    invoke-super {p0, v0, v2, v3, v4}, Landroid/support/v7/widget/f;->setPadding(IIII)V

    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/f;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Landroid/support/v7/widget/f;->onMeasure(II)V
    ...
    invoke-super {p0, v0, v1, v2, v3}, Landroid/support/v7/widget/f;->setPadding(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Landroid/support/v7/widget/f;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/f;->setPadding(IIII)V
